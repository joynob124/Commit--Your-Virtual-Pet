...
The installer for turso_cli 0.6.1

.DESCRIPTION

This script detects what platform you're on and fetches an appropriate archive from
https://github.com/tursodatabase/turso/releases/download/v0.6.1
